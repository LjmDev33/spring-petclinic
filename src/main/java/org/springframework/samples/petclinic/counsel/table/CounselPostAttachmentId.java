 ...
 * File    : CounselPostAttachmentId.java
 * Created : 2025-10-23
 * Author  : Jeongmin Lee
 *
 * Description :
 ...
 */
@Embeddable
public class CounselPostAttachmentId implements Serializable {

	private Long counselPostId;
	private Long attachmentId;

	public CounselPostAttachmentId() {}
	public CounselPostAttachmentId(Long counselPostId, Long attachmentId) {
		this.counselPostId = counselPostId;
		this.attachmentId = attachmentId;
	}

	// equals/hashCode
	@Override public boolean equals(Object o){ if(this==o) return true; if(!(o instanceof CounselPostAttachmentId that)) return false;
		return Objects.equals(counselPostId, that.counselPostId) && Objects.equals(attachmentId, that.attachmentId); }
	@Override public int hashCode(){ return Objects.hash(counselPostId, attachmentId); }

	public Long getCounselPostId() {
		return counselPostId;
	}

	public void setCounselPostId(Long counselPostId) {
		this.counselPostId = counselPostId;
	}
