 ...
 * File    : CounselCommentAttachmentId.java
 * Created : 2025-10-23
 * Author  : Jeongmin Lee
 *
 * Description :
 ...
 */
@Embeddable
public class CounselCommentAttachmentId implements Serializable {

	private Long counselCommentId;
	private Long attachmentId;

	public CounselCommentAttachmentId() {}
	public CounselCommentAttachmentId(Long counselCommentId, Long attachmentId) {
		this.counselCommentId = counselCommentId;
		this.attachmentId = attachmentId;
	}

	@Override public boolean equals(Object o){ if(this==o) return true; if(!(o instanceof CounselCommentAttachmentId that)) return false;
		return Objects.equals(counselCommentId, that.counselCommentId) && Objects.equals(attachmentId, that.attachmentId); }
	@Override public int hashCode(){ return Objects.hash(counselCommentId, attachmentId); }

	public Long getCounselCommentId() {
		return counselCommentId;
	}

	public void setCounselCommentId(Long counselCommentId) {
		this.counselCommentId = counselCommentId;
	}
